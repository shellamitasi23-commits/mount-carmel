...
class KavlingController extends Controller
{
    public function index()
    {
        ...
        return view('marketing.kavling.index', compact('kavlings', 'clusters', 'tipe_kavlings'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('marketing.kavling.index')
            ->with('success', 'Lahan #' . $validated['nomor_kavling'] . ' berhasil ditambahkan!');
    }
