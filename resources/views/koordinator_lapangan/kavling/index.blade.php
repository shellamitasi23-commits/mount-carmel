...
{{-- Search --}}
<div class="mb-6">
    <input id="kavling-search" type="text" placeholder="cari lahan (nomor, lahan, cluster, status, harga)..." 
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm whitespace-nowrap">
                ...
                <tbody class="divide-y divide-slate-50 text-slate-700">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors"
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex justify-center gap-2">
                                ...
                                <form action="{{ route('koordinator_lapangan.kavling.destroy', $kavling->id) }}" method="POST"
                                      onsubmit="return confirm('Yakin hapus lahan #{{ $kavling->nomor_kavling }}?')">
                                    @csrf @method('DELETE')
                                    <button type="submit"
                    ...
                    @if(auth()->user()->role == 'koordinator_lapangan')
                    @include('koordinator_lapangan.kavling.edit')
                    @endif
                    @empty
                    <tr>
...
@if(auth()->user()->role == 'koordinator_lapangan')
@include('koordinator_lapangan.kavling.create')
@endif
