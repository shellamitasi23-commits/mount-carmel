        ...
        <table class="w-full text-left text-xs">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-slate-600 font-medium">{{ $pembeli->email }}</td>
                    <td class="px-6 py-4 font-mono font-semibold text-slate-600">{{ $pembeli->no_telepon ?? 'Belum Diisi' }}</td>
                    <td class="px-6 py-4 text-slate-500 max-w-xs truncate">{{ $pembeli->alamat ?? 'Belum Diisi' }}</td>
                    <td class="px-6 py-4 text-slate-400 font-medium">{{ $pembeli->created_at->format('d M Y') }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="5" class="px-6 py-14 text-center text-slate-400 italic">
