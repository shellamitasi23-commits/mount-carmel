...
<div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('marketing.laporan.pdf') }}" class="bg-primary hover:bg-opacity-90 text-white px-5 py-2.5 rounded-xl font-semibold flex items-center gap-2 transition-all shadow-md text-sm">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <h3 class="font-bold text-gray-800 mb-4">Tipe Lahan Terlaris</h3>
        <div class="space-y-5">
            @php $index = 0; @endphp
