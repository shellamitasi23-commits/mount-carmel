    ...
    <div class="lg:col-span-2 flex flex-col gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
            <div class="px-4 py-3 border-b border-slate-50 flex items-center justify-between">
                ...
                <a href="{{ route('marketing.reservasi.index') }}" class="text-[10px] font-bold text-[#800000] hover:underline uppercase tracking-wider flex items-center gap-1">
                    Data Reservasi
                    ...
                    <tbody class="divide-y divide-slate-50 text-xs">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="px-4 py-2.5">
                                <a href="{{ route('marketing.reservasi.index') }}" class="font-bold text-slate-900 hover:text-[#800000] uppercase leading-none transition-colors block">
                                    {{ $sale['name'] }}
                                </a>
