...
<div class="bg-white p-4 rounded-xl shadow-sm border border-slate-100 mb-6">
    <form method="GET" action="{{ route('marketing.reservasi.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
        ...
        <div class="flex">
            ...
            <a href="{{ route('marketing.reservasi.index') }}" class="w-full px-5 py-2 bg-slate-100 text-slate-500 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-slate-200 transition-all text-center flex items-center justify-center">
                Reset
            </a>
            @endif
        </div>
...
<div id="modalTambah" class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm hidden flex items-center justify-center z-50 p-6">
    <div class="bg-white rounded-xl w-full max-w-xl shadow-2xl overflow-y-auto max-h-[90vh]">
        <div class="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
            <h3 class="text-lg font-bold text-slate-800">Input Reservasi Baru</h3>
        ...
        <form action="{{ route('marketing.reservasi.store') }}" method="POST" class="p-6 space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="user_id" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-slate-900/5 outline-none appearance-none">
                ...
                <div>
                    ...
                    <select name="lahan_id" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-slate-900/5 outline-none appearance-none">
            ...
            <div>
                ...
                <input type="text" name="nama_jenazah" placeholder="Contoh: Alm. Fulan bin Fulan"
                       class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-slate-900/5 outline-none">
            </div>
            ...
            <div>
                ...
                <input type="date" name="tanggal_dimakamkan" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-slate-900/5 outline-none">
            </div>
