        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @php
                    ...
                    $hargaMax       = $cluster->kavlings->max('harga');
                ...
                <div data-aos="fade-up" data-aos-delay="{{ ($i % 3) * 100 }}"
                    ...
                    <div class="relative h-56 overflow-hidden">
                        ...
                        <span class="absolute top-4 left-4 inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold
                            {{ $isMuslim ? 'bg-white/90 text-gray-900' : 'bg-white/90 text-gray-900' }}">
                        ...
                        <div class="absolute bottom-4 left-5 right-5">
                            <h3 class="font-display text-xl font-bold text-white drop-shadow-md">{{ $cluster->nama_cluster }}</h3>
                        </div>
                    </div>
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex flex-wrap gap-1.5">
                                ...
                                <span class="px-2.5 py-1 bg-gray-100 dark:bg-gray-800 text-gray-400 rounded-lg text-[11px] font-semibold">
                        ...
                        <!-- CTA Button -->
                        <a href="{{ route('cluster.show', $cluster->id) }}"
...
{{-- Filter Alpine sync --}}
<script>
    // Sync filter bar dan grid dengan satu state Alpine
    document.addEventListener('alpine:init', () => {
        Alpine.store('clusterFilter', { value: 'semua' });
    });
</script>
